...
<body>
  ...
  <div id="main">
    ...
    <div style="float:left; width: 650px;">
      <a href="index.php"><img src="http://localhost/php_ecommerce-master/php_ecommerce-master/Photos/indiana_university_logo.png" alt="" width="300px" border-radius: "11px";/></a>
